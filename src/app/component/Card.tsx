 ...
 useEffect(() => {
  ...
  return (
    <div className=" pt-[70px] place-items-center">
      <h1 className="text-4xl text-center font-bold mb-8 underline text-[red]">Products</h1>
...
<Link href="/cart"><div className="bg-yellow-400 hover:bg-yellow-500 text-white text-center py-2 px-6 mt-4 mb-4 rounded">Go to cart ({cart.length})</div></Link>
    </div>
  );
};
